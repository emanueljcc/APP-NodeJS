...
function pieChart() {
  ...
  var pullOutValuePrefix = "R$ ";                     // Pull-out slice value prefix
  var pullOutShadowColour = "rgba( 0, 0, 0, .5 )";  // Colour to use for the pull-out slice shadow
  var pullOutShadowOffsetX = 8;                     // X-offset (in pixels) of the pull-out slice shadow
  var pullOutShadowOffsetY = 8;                     // Y-offset (in pixels) of the pull-out slice shadow
